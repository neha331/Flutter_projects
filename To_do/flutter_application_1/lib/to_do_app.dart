...
void initState() {
  ...
  Future<List<ToDoModelClass>> fetchDataFromDatabase() async {


//   void loadDataFromDatabase() async {
//   List<ToDoModelClass> data = await fetchDataFromDatabase();
//   setState(() {
//     cardList = data;
//   });
// }
...
//   }
  ...
  try {
    ...
    querySnapshot.docs.forEach((doc) {
      ToDoModelClass todo = ToDoModelClass.fromMap(doc.data() as Map<String, dynamic>);
      todoList.add(todo);
    });
 ...
 // bool doedit =false;
  ...
  if (titleController.text.trim().isNotEmpty &&
    ...
    if (!doedit) {
      ...
      FirebaseFirestore.instance.collection('todos').doc(toDoModelObj?.id).set({
         toDoModelObj!.title: titleController.text.trim(),
         toDoModelObj.description: descriptionController.text.trim(),
         toDoModelObj.date: dateController.text.trim(),
